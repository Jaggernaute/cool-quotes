...
@generated_exts = ( 'aux', 'bcf', 'fls', 'idx', 'ind', 'lof', 'lot', 'out', 'toc', 'log', 'fdb_latexmk', 'blg', 'run.xml', 'synctex.gz');
...
print `find . -maxdepth 4 -type f -name "*.tex" | # find all tex files up to 4 levels deep
